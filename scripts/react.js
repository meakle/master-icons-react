...
import { createPackage, deleteFilesRecursively, genCompFile, preprocessSvg } from './utils.js';

const filename = fileURLToPath(import.meta.url);
const dirname = path.dirname(filename);

const getReactExportTemplate = (svg, name) => {
...
const genMappingFile = (
  ...
  const getMappingExportTemplate = (component) => {
...
export const genReact = (sourcesSVGs) => {
  const reactConfig = {

...
export const createPackage = (packageDir) => {
...
export const deleteFilesRecursively = (dirPath) => {
...
export const genConfigJson = (jsonPath, targetPath) => {
  // 读取 json 文件
  const jsonObj = JSON.parse(fs.readFileSync(jsonPath, 'utf-8'));
